...
echo -e "\033[1;33m $(fun_trans "Host changed correctly")!, $(fun_trans "reiniciar VPS")"
else
...
echo -e "${cor[3]} $(fun_trans "This password is used as a user") root"
msg -bar
echo -ne " $(fun_trans "Want to Follow?") [S/N]: "; read x
...
echo -e "${cor[3]}             GoogleCloud and Amazon"
msg -bar
echo -ne " Want to Follow? [S/N]: "; read x
[[ $x = @(n|N) ]] && msg -bar && return
msg -bar
#Inicia Procedimentos
...
sleep 1s
msg -bar
echo -e "${cor[3]} Configurations successfully applied!"
...
pamcrack () {
echo -e "${cor[3]} $(fun_trans "Release passwd for VURTL")"
msg -bar
echo -ne " $(fun_trans "Want to Follow?") [S/N]: "; read x
[[ $x = @(n|N) ]] && msg -bar && return
echo -e ""
...
echo -e "${cor[4]} [3] > \033[1;36mVPS RESTART"
echo -e "${cor[4]} [4] > \033[1;36mCHANGE HOSTNAME VPS"
echo -e "${cor[4]} [5] > \033[1;36mCHANGE ROOT PASSWORD"
echo -e "${cor[4]} [6] > \033[1;36mCHANGE LOCAL TIME MX"
echo -e "${cor[4]} [7] > \033[1;36mCHANGE LOCAL TIME ARG"
echo -e "${cor[2]} [8] > \033[1;100mAADD ROOT to GoogleCloud and Amazon \033[0;37m"
