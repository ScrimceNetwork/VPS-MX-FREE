...
[[ ! -e "/bin/ShellBot.sh" ]] && wget -O /bin/ShellBot.sh https://raw.githubusercontent.com/AorsiniYT/VPS-MX-FREE/main/Files/ShellBot.sh &> /dev/null
...
local bot_retorno="*$LINE*\n"
		  ...
		  bot_retorno+="*$LINE*\n"
          bot_retorno+="_Ejemplo: /SSHI Aorsini-xzcmo _\n"
          bot_retorno+="*$LINE*\n"
	      ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
							--text "$(echo -e $bot_retorno)" \
							--parse_mode markdown
