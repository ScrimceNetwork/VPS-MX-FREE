...
err_fun () {
     ...
     2)msg -verm "$(fun_trans "very short name (MIN: 2 CARACTERES)")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
     3)msg -verm "$(fun_trans "very big name (MAX: 5 CARACTERES)")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
     ...
     7)msg -verm "$(fun_trans "Duration Null")"; sleep 2s; tput cuu1; tput dl1; tput cuu1; tput dl1;;
...
echo ""
echo -e " Port Selected: $portbg | Amount of GB: $gbuser"
echo ""
...
echo -ne "\033[1;32m [4] > " && msg -azu "$(fun_trans "CHANGE PORT V2RAY")\n$(msg -bar) "
## CONTROLER
...
[[ $(echo "${portas[@]}"|grep "$1") ]] && echo -e "\033[1;32m[ Active service ]" || echo -e "\033[1;31m[ Service Deactivated ]"
}
echo -e "         \e[97mCurrent status: $(pid_inst v2ray)"
msg -bar
